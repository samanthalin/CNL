(function (global) {
    var mainMenu = {
        ...
        writeMenu: function (params) {
            ...
            // F01        ----------------------------------------------------------------------
            document.write("<li>");
            document.write("<a href=\".\\pages\\f01\\F010001_SCN1.html\" menuType=\"01\">銀行資料維護<span class=\"caret\"></span></a>");
            ...
            document.write("</li>");
            document.write("<li>");
            document.write("<a href=\".\\pages\\f01\\F010008_SCN1.html\" menuType=\"01\" class=\"pure-menu-link\">兆豐業務員上傳資料</a>");
            document.write("</li>");
            document.write("</ul>");
            document.write("</li>");
            ...
            // F01-2      ----------------------------------------------------------------------
            document.write("<li>");
            document.write("<a href=\".\\pages\\f01\\F010006_SCN1.html\" menuType=\"01\">資料上傳<span class=\"caret\"></span></a>");
            document.write("<ul class=\"dropdown-menu\">");
            document.write("<li>");
            ...
            // F00        ----------------------------------------------------------------------
            document.write("<li>");
            document.write("<a href=\".\\pages\\f01\\F000005_SCN1.html\" menuType=\"01\">功能權限設定<span class=\"caret\"></span></a>");
            document.write("<ul class=\"dropdown-menu\">");
            document.write("<li>");
            document.write("<a href=\".\\pages\\f01\\F000005_SCN1.html\" menuType=\"01\" class=\"pure-menu-link\">系統功能設定</a>");
            document.write("</li>");
            document.write("<li>");
            document.write("<a href=\".\\pages\\f01\\F000002_SCN1.html\" menuType=\"01\" class=\"pure-menu-link\">群組權限設定</a>");
            document.write("</li>");
            document.write("</ul>");
            document.write("</li>");
            // F00        ----------------------------------------------------------------------
            document.write("<li>");
            document.write("<a href=\".\\pages\\f01\\F000001_SCN1.html\" menuType=\"01\">其他<span class=\"caret\"></span></a>");
            document.write("<ul class=\"dropdown-menu\">");
            document.write("<li>");
            document.write("<a href=\".\\pages\\f01\\F000001_SCN1.html\" menuType=\"01\" class=\"pure-menu-link\">下載中心</a>");
            document.write("</li>");
            document.write("</ul>");
            document.write("</li>");
